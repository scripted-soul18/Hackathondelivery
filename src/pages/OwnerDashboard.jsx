...
const generateTopProducts = () => [
    { name: 'Organic Bananas', sold: Math.floor(30 + Math.random() * 20), revenue: 0, trend: 'up'import { useState, useEffect } from 'react';
import { motion } from 'framer-motion';
import { useAuth } from '../context/AuthContext';
import { useNavigate } from 'react-router-dom';
import {
...
function OrganicBananas() {
    return (
      <div className="App">
        <img src={require("https://unsplash.com/photos/a-bunch-of-ripe-yellow-bananas-with-brown-spots-Wim9GsDlHEU")} alt="Organic Bananas image" />
      </div>
      );
  }
...
const generateTopProducts = () => [
    { name: 'Organic Bananas', sold: Math.floor(30 + Math.random() * 20), revenue: 0, trend: 'up' },function OrganicBananas() {
        return (
          <div className="App">
            <img src={require("https://unsplash.com/photos/a-bunch-of-ripe-yellow-bananas-with-brown-spots-Wim9GsDlHEU")} alt="Organic Bananas image" />
          </div>
...
].map(p => ({ ...p, revenue: Math.floor(p.sold * (8 + Math.random() * 20)) }));
                    ...
                    <div className="space-y-2.5">
                        {topProducts.map((p, i) => (
                            <div key={p.name} className="flex items-center gap-3">
                                <span className="w-6 h-6 rounded-lg bg-slate-100 text-slate-500 flex items-center justify-center text-xs font-bold">{i + 1}</span>
